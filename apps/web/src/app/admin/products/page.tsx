        ...
        {loading ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredProducts.map((product) => (
              <div key={product.id} className="bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700 overflow-hidden">
                <div className="aspect-video bg-gray-100 dark:bg-gray-700 relative">
                  ...
                  <div className={`absolute top-2 right-2 px-2 py-1 rounded text-xs font-medium ${
                    product.isActive ? "bg-green-100 text-green-700" : "bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300"
                  }`}>
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-2 mt-4">
                    ...
                    <button className="p-2 border dark:border-gray-700 rounded-lg hover:bg-red-50 hover:border-red-200 hover:text-red-600 transition dark:text-gray-300">
                      <Trash2 size={16} />
                    </button>
                  </div>
                </div>
