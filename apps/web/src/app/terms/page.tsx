      ...
      <main className="min-h-screen bg-light-grey">
        <div className="container py-12">
          ...
          <div className="bg-white rounded-xl border p-8 prose prose-lg max-w-4xl">
            ...
            <p>
              All orders are subject to acceptance. Prices are quoted in Nigerian Naira (₦) and are exclusive of taxes unless stated otherwise. Payment is processed securely through Flutterwave. Orders are not considered confirmed until payment is received.
            </p>
