...
export const metadata: Metadata = {
  ...
  description: "Buy laboratory equipment, chemical lab supplies, medical instruments, and scientific apparatus in Nigeria. De-Omega Labaffairs — procurement, installation & maintenance for universities, hospitals & industries across Nigeria.",
  keywords: [
    "laboratory equipment Nigeria",
    "chemical laboratory supplies Nigeria",
    "buy lab chemicals Nigeria",
    "scientific chemicals Nigeria",
    ...
    "lab supplies Nigeria",
    "medical instruments",
    "research equipment Nigeria",
    "pharmaceutical equipment",
    "quality control instruments",
    "buy laboratory equipment online Nigeria",
  ],
  ...
  openGraph: {
    ...
    description: "Buy laboratory equipment, chemical lab supplies, medical instruments, and scientific apparatus in Nigeria. Procurement, installation & maintenance for universities, hospitals, and industries.",
    images: ["/logo.png"],
