...
export function Footer() {
  const config = PUBLIC_SITE_CONFIG;
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <h3 className="text-white font-heading font-bold text-xl">{config.company.name}</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <a href={`mailto:${config.company.email}`} className="hover:text-white transition-colors">
                  {config.company.email}
                </a>
              </li>
              <li className="flex items-start gap-2">
                <Phone size={16} className="mt-0.5 flex-shrink-0" />
                <a href={`tel:${config.company.phone}`} className="hover:text-white transition-colors">
