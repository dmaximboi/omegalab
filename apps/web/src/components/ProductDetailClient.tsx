...
export function ProductDetailClient({ product, siteOrigin }: Props) {
  ...
  const shareProduct = async () => {
    ...
    const shareData = {
      title: product.name,
      text: `Check out ${product.name} for ₦${product.price.toLocaleString()} — buy lab & chemical supplies in Nigeria from De-Omega Labaffairs`,
      url,
    };
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="space-y-4">
            <div
              className="relative aspect-square bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700 overflow-hidden"
